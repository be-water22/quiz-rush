                  ...
                  children: [
                    ...
                    Row(
                      children: List.generate(game.totalRounds, (i) {
                        final isDone = i + 1 < game.currentRound;
                        final isActive = i + 1 == game.currentRound;
                        return Container(
                          width: 8,
                          height: 8,
                    ...
                    ...List.generate(
                      ...
                      (i) => Padding(
                        ...
                        child: OptionButton(
                          ...
                          isSelected: game.selectedAnswerIndex == i,
                          isCorrect: game.answerCorrect != null
                              ? (game.selectedAnswerIndex == i ? game.answerCorrect : null)
                              : null,
                          onTap: game.selectedAnswerIndex == null
